  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex items-center justify-center p-6">
      <div className="max-w-md w-full text-center space-y-6 bg-zinc-900 border border-zinc-800 p-8 rounded-2xl shadow-2xl">
        <div className="mx-auto w-16 h-16 bg-red-500/10 border border-red-500/30 rounded-2xl flex items-center justify-center text-red-400">
          <AlertTriangle className="w-8 h-8" />
        </div>

        <div className="space-y-2">
          <span className="text-red-400 font-mono text-sm tracking-wider uppercase">Application Error</span>
        ...
        {error.digest && (
          <div className="bg-zinc-950 p-2 rounded-lg border border-zinc-800 font-mono text-xs text-zinc-500">
            Digest: {error.digest}
          </div>
        )}
